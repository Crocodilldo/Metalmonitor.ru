...
class ParsingService
{
    public function __construct(
        protected GetContentService $fetcher,
        protected ProductInfoExtractorService $extractor,
        protected ProductParameterNormalizerService $normalizer,
        protected ProductBuilderService $builder,
        protected ProductStoreService $store
    ) {}
    ...
    public function parseProducts(
        ...
        $selectors = QuerySelector::where('shop_id', $shopId)->firstOrFail();
